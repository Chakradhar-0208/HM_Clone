...
export default function Header() {
  ...
  return (
    <div className="relative z-501">
      <header className="py-1 pb-4 pl-3 pr-0 lg:px-5 bg-white fixed top-0 left-0 right-0 z-30 shadow">
        <div className="">
          <div className="flex justify-between items-center mb-2 text-sm h-10">
            <p className="text-red-600 w-60 sm:w-auto">SHOP UNDER ₹699 | SUMMER SALE IS LIVE</p>
            <div>
              <div
              ...
              >
                {showDiv ? (
                  <>
                    <a href="#" className="flex items-center flex-row text-black underline w-20">
                      SHOP NOW
                    </a>
                  ...
                  <div>
                    <div className=" flex items-center absolute right-0 w-fit">
                      <a href="#" className="flex items-center flex-row text-black underline w-22">
                        CLOSE THIS
                      </a>
                      <button className="p-2 rounded hover:bg-gray-200">
      ...
      <nav className="flex justify-center items-center lg:justify-start lg:fixed lg:top-[4.7rem] lg:left-[8.75rem] font-black mb-3 lg:mb-0 sticky top-0 lg:z-30
        ">
